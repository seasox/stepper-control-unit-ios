...
protocol BluetoothSerialType: class {
    var delegate: BluetoothSerialDelegate? { get set }
    ...
    func sendMessageToDevice(_ msg: String)
}

extension BluetoothSerial: BluetoothSerialType {
